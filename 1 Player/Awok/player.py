...
class Player(pygame.sprite.Sprite):
    #setup umum
    def __init__(self, pos, group, collision_sprites, coin_collision_sprites, pos1_collision_sprites, pos2_collision_sprites,
                 pos3_collision_sprites, pos4_collision_sprites, pos5_collision_sprites, gate_info, interaction):
    ...
    #tabrakan
        ...
        self.coin_collision_sprites = coin_collision_sprites
        self.coin = 0
        ...
        self.pos3_collision_sprites = pos3_collision_sprites
        self.pos4_collision_sprites = pos4_collision_sprites
        self.pos5_collision_sprites = pos5_collision_sprites
        print(self.coin)
        ...
        self.game_soal3 = False
        self.game_soal4 = False
        self.game_soal5 = False
    ...
    def input(self):
        ...
        if not self.timers['tool use'].active:
            #direction
            if self.game_soal1 == False | self.game_soal2 == False | self.game_soal3 == False | self.game_soal4 == False | self.game_soal5 == False:
                if keys[pygame.K_UP]:
                    self.direction.y = -1
                    self.status = 'Atas'
            ...
            if self.pos3 == True:
                if keys[pygame.K_f]:
                    self.game_soal3 = True
                    # print('soal1')
                if keys[pygame.K_ESCAPE]:
                    self.game_soal3 = False
            if self.pos4 == True:
                if keys[pygame.K_f]:
                    self.game_soal4 = True
                    # print('soal1')
                if keys[pygame.K_ESCAPE]:
                    self.game_soal4 = False
            if self.pos5 == True:
                if keys[pygame.K_f]:
                    self.game_soal5 = True
                    # print('soal1')
                if keys[pygame.K_ESCAPE]:
                    self.game_soal5 = False
            if keys[pygame.K_ESCAPE]:
    ...
    def menu(self):
        ...
        if self.game_soal2 == True:
            ...
            self.game_soal2 = False
        if self.game_soal3 == True:
            self.display_soal.blit(gambarsoal3, (128, 100))
        elif self.pos3 == False:
            self.game_soal3 = False
        if self.game_soal4 == True:
            self.display_soal.blit(gambarsoal4, (128, 100))
        elif self.pos4 == False:
            self.game_soal4 = False
        if self.game_soal5 == True:
            self.display_soal.blit(gambarsoal5, (128, 100))
        elif self.pos5 == False:
            self.game_soal5 = False
    ...
    def pos3_collision(self):
        for sprite in self.pos3_collision_sprites.sprites():
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    self.pos3 = True
                    trigger_text = self.font.render('Tekan F untuk membuka soal', True, (255, 255, 255))
    ...
    def pos4_collision(self):
        for sprite in self.pos4_collision_sprites.sprites():
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    self.pos4 = True
                    trigger_text = self.font.render('Tekan F untuk membuka soal', True, (255, 255, 255))
    ...
    def pos5_collision(self):
        for sprite in self.pos5_collision_sprites.sprites():
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    self.pos5 = True
                    trigger_text = self.font.render('Tekan F untuk membuka soal', True, (255, 255, 255))
    ...
    def coin_collision(self):
        for sprite in self.coin_collision_sprites.sprites():
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    # self.coin += 1
                    sprite.kill()
    ...
    def finish_collision(self):
        for sprite in self.interaction.sprites():
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    # self.coin += 1
                    trigger_text2 = self.font.render('Tekan ENTER untuk mengakhiri permainan', True, (255, 255, 255))
                    self.display_surface.blit(trigger_text2, ((SCREEN_WIDTH/2)-400, (SCREEN_HEIGHT/2)+300))
